<style>
    ...
    <div class="container py-4">
        <h1 class="h3">Tâches du Projet</h1>
        <div class="mb-3"></div>
            <?php if (is_manager()): ?>
                    ...
                    <?php if ($task['status'] === 'todo'): ?>
                        <div class="task" draggable="true" data-id="<?= $task['id']?>" ondragstart="drag(event)">
                            <div class="task-header">
                                ...
                                <span class="badge bg-info"><?= htmlspecialchars($task['assigned_user'] ?? 'Non assigné') ?></span>
                            </div>
                            <div class="task-body">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= base_url('projects/' . $project['id'] . '/tasks/' . $task['id'] . '/assign') ?>" method="POST">
